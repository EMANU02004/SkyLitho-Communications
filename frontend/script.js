...
// ADMIN PANEL
// ══════════════════════════════════════════
// SHA-256 of the admin password — plain text never stored here
// To change password: node -e "require('crypto').createHash('sha256').update('newpass').digest('hex')" | copy result below
const ADMIN_HASH = '68aa5ac2bcb2cef7dec08705802b3f1d84e95385b439f882b64a607d1077298f';
